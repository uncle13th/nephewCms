$(function(){
    ...
    function init(){
        ...
        $(".fa-reorder").on('click', function(){
            var type = $(this).attr('k');
            window.location.href = '/home/product/list?type='+type;
        })
    ...
    function showAddModal(){
        $('#operation').val('add');
        $("#infoModal .box-header h3").html('新增类型');
        clearModalData();
        $('#infoModal').modal({'backdrop' : false});
    }
    ...
    function showEditModal(data){
        $('#operation').val('edit');
        $("#infoModal .box-header h3").html('修改类型');
        setModalData(data);
        $('#infoModal').modal({'backdrop' : false});
    }
    ...
    function setModalData(data){
        ...
        if(obj.show == 1){
            ...
            $('input:radio[name="show"]').eq(1).prop('checked', "checked");
        }
    ...
    function saveData(){
        ...
        //跳转链接
        var href_url = '/home/product/type';

        $.ajax({
            type: "post",
            url: "/home/product/type",
            data: data,
            dataType: "json",
            ...
            success: function (respone) {
                if (respone.code != 200) {
                    ...
                    $('#delModal').on('hidden.bs.modal', function (e) {
                        window.location.href = '/home/product/type';
                    })
