        ...
        <div class="container col-xs-12 col-sm-12 col-md-12">
            <div class="col-xs-6 col-sm-6 col-md-6">
                <ol class="breadcrumb" style="font-size: 16px;background-color: #ecf0f5;">
                    ...
                    <li class="active"><i class="fa fa-fw fa-user"></i>产品类型管理</li>
                </ol>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6">
                <button id="addData" class="btn btn-info pull-right"><span class="fa fa-fw fa-plus-circle"></span>新增类型</button>
            </div>
        </div>
    </section>
                            ...
                            <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        @endif
                                        @if($type['status'] == 1 && $type['show'] == 1)
                                            <small class="label label-success"><i class="fa fa-clock-o"></i>首页展示</small>
                                        @endif
                                    </div>
                                    <div class="col-md-2">
                                        <div class="tools" style="display:block">
                                            <i class="fa fa-fw fa-reorder" k="{{$type['id']}}"></i>
                                            <i class="fa fa-edit" k="{{json_encode($type)}}"></i>
                                            <i class="fa fa-trash-o" k="{{$type['id']}}"></i>
                                        </div>
                                    </div>
                                </div>
                            </li>
